...
Namespace Scaffolding.ValidationErrors.Common.DataModel
  ...
  Public Interface IRepository(Of TEntity As Class, TPrimaryKey)
    ...
    Sub Detach(ByVal entity As TEntity)    
    ''' <summary>
  ...
  Public Module RepositoryExtensions
    ...
    Public Function GetPrimaryKeyEqualsExpression(Of TEntity As Class, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal key As TPrimaryKey) As Expression(Of Func(Of TEntity, Boolean))
      Return ExpressionHelper.GetValueEqualsExpression(repository.GetPrimaryKeyExpression, key)
    End Function
    <System.Runtime.CompilerServices.Extension> _
    Public Function GetProjectionPrimaryKeyEqualsExpression(Of TEntity As Class, TProjection, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal key As TPrimaryKey) As Expression(Of Func(Of TProjection, Boolean))
      Return GetProjectionValue(key, Function(ByVal x As TPrimaryKey) repository.GetPrimaryKeyEqualsExpression(x), Function(ByVal x As TPrimaryKey) GetProjectionPrimaryKeyEqualsExpressionCore(Of TEntity, TProjection, TPrimaryKey)(repository, x))
    End Function
    <System.Runtime.CompilerServices.Extension> _
    Public Function GetProjectionPrimaryKey(Of TEntity As Class, TProjection, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal projection As TProjection) As TPrimaryKey
      Return GetProjectionValue(projection, Function(ByVal x As TEntity) repository.GetPrimaryKey(x), Function(ByVal x As TProjection) CType(TypeDescriptor.GetProperties(GetType(TProjection))(repository.GetPrimaryKeyPropertyName()).GetValue(x), TPrimaryKey))
    End Function
    <System.Runtime.CompilerServices.Extension> _
    Public Function IsDetached(Of TEntity As Class, TProjection, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal projection As TProjection) As Boolean
      Return GetProjectionValue(projection, Function(ByVal x As TEntity) repository.GetState(x) = EntityState.Detached, Function(ByVal x As TProjection) False)
    End Function
    <System.Runtime.CompilerServices.Extension> _
    Public Function ProjectionHasPrimaryKey(Of TEntity As Class, TProjection, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal projection As TProjection) As Boolean
      Return GetProjectionValue(projection, Function(ByVal x As TEntity) repository.HasPrimaryKey(x), Function(ByVal x As TProjection) True)
    End Function
    <System.Runtime.CompilerServices.Extension> _
    ...
    End Function
    Private Function GetProjectionPrimaryKeyEqualsExpressionCore(Of TEntity As Class, TProjection, TPrimaryKey)(ByVal repository As IRepository(Of TEntity, TPrimaryKey), ByVal key As TPrimaryKey) As Expression(Of Func(Of TProjection, Boolean))
