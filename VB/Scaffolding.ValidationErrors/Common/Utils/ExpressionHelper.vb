...
Namespace Scaffolding.ValidationErrors.Common.Utils
  ...
  Public Class ExpressionHelper
    ...
    End Function
    Public Shared Function IsFitEntity(Of TEntity As Class)(ByVal entity As TEntity, ByVal filterExpression As Expression(Of Func(Of TEntity, Boolean))) As Boolean
      Return filterExpression Is Nothing OrElse (New TEntity() { entity }.AsQueryable().Any(filterExpression))
    End Function
