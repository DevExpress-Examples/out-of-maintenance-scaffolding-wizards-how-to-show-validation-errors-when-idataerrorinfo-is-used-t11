...
Namespace Scaffolding.ValidationErrors.ViewModels
    ...
    Partial Public Class DepartmentContextViewModel
        ...
        Protected Overrides Function CreateModules() As DepartmentContextModuleDescription()
            Return New DepartmentContextModuleDescription() { New DepartmentContextModuleDescription("Departments", "DepartmentCollectionView", TablesGroup, GetPeekCollectionViewModelFactory(Function(x) x.Departments))}
        End Function
